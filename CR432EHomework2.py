...
# Print a blank line followed by the partially decrypted text.
print("")
print(f"Expanded key: {expanded_decryption_key}.")
...
decrypted_text_testbin = guess_txt(bytes(testbin_unsorted_bytes), expanded_decryption_key)

# Print a blank line followed by the decrypted text using the expanded decryption key.
print("")
print(f"Fully decrypted text (test.bin): {decrypted_text_testbin}")
